...
google-admin: target/debug/generator $(GOOGLE_ADMIN_SPEC)
	./target/debug/generator -i $(GOOGLE_ADMIN_SPEC) -v 0.2.5 \
		-o google/admin \
		-n gsuite-api \
...
google-calendar: target/debug/generator $(GOOGLE_CALENDAR_SPEC)
	./target/debug/generator -i $(GOOGLE_CALENDAR_SPEC) -v 0.1.5 \
		-o google/calendar \
		-n google-calendar \
...
google-cloud-resource-manager: target/debug/generator $(GOOGLE_CLOUD_RESOURCE_MANAGER_SPEC)
	./target/debug/generator -i $(GOOGLE_CLOUD_RESOURCE_MANAGER_SPEC) -v 0.1.2 \
...
google-drive: target/debug/generator $(GOOGLE_DRIVE_SPEC)
	./target/debug/generator -i $(GOOGLE_DRIVE_SPEC) -v 0.2.9 \
		-o google/drive \
		-n google-drive \
...
google-groups-settings: target/debug/generator $(GOOGLE_GROUPS_SETTINGS_SPEC)
	./target/debug/generator -i $(GOOGLE_GROUPS_SETTINGS_SPEC) -v 0.1.5 \
...
google-sheets: target/debug/generator $(GOOGLE_SHEETS_SPEC)
	./target/debug/generator -i $(GOOGLE_SHEETS_SPEC) -v 0.2.3 \
		-o google/sheets \
		-n sheets \
